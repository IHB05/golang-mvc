...
func (_m *UserRepository) FindAll(page int, limit int, search string) ([]models.User, int64, error) {
...
// Update provides a mock function with given fields: user, updates
func (_m *UserRepository) Update(user *models.User, updates map[string]interface{}) error {
	ret := _m.Called(user, updates)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*models.User, map[string]interface{}) error); ok {
		r0 = rf(user, updates)
	} else {
		r0 = ret.Error(0)
	}
